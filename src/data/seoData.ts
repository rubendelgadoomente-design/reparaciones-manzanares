...
export const locationsData: LocationData[] = [
  { 
    ...
    nearbyLocations: ["Soto del Real", "El Boalo", "Cerceda", "Colmenar Viejo"]
  },
  { 
    name: "Colmenar Viejo", 
    ...
    nearbyLocations: ["Manzanares el Real", "Soto del Real", "Moralzarzal", "Collado Villalba"]
  },
  { 
    ...
    nearbyLocations: ["Alpedrete", "Moralzarzal", "Guadarrama", "Los Molinos"]
  },
  { 
    name: "Moralzarzal", 
    timeToArrive: "15 minutos", 
    ...
    nearbyLocations: ["Collado Villalba", "Alpedrete", "Cerceda", "El Boalo"]
  },
  { 
    name: "Alpedrete", 
    timeToArrive: "20 minutos", 
    ...
    nearbyLocations: ["Collado Villalba", "Guadarrama", "Navacerrada", "Moralzarzal"]
  },
  { 
    name: "Guadarrama", 
    ...
    nearbyLocations: ["Alpedrete", "Los Molinos", "Collado Villalba", "Navacerrada"]
  },
  { 
    name: "Cerceda", 
    ...
    nearbyLocations: ["El Boalo", "Mataelpino", "Manzanares el Real", "Moralzarzal"]
  },
  { 
    name: "El Boalo", 
    timeToArrive: "10 minutos", 
    ...
    nearbyLocations: ["Cerceda", "Mataelpino", "Manzanares el Real", "Moralzarzal"]
  },
  { 
    name: "Mataelpino", 
    timeToArrive: "15 minutos", 
    ...
    nearbyLocations: ["El Boalo", "Cerceda", "Becerril de la Sierra", "Navacerrada"]
  },
  { 
    ...
    nearbyLocations: ["Mataelpino", "Navacerrada", "Moralzarzal", "Cerceda"]
  },
  { 
    name: "Navacerrada", 
    timeToArrive: "25 minutos", 
    ...
    nearbyLocations: ["Becerril de la Sierra", "Cercedilla", "Los Molinos", "Mataelpino"]
  },
  { 
    name: "Cercedilla", 
    ...
    nearbyLocations: ["Los Molinos", "Navacerrada", "Becerril de la Sierra"]
  },
  { 
    name: "Los Molinos", 
    timeToArrive: "25 minutos", 
    ...
    nearbyLocations: ["Guadarrama", "Cercedilla", "Navacerrada", "Alpedrete"]
  },
  { 
    ...
    nearbyLocations: ["Soto del Real", "Manzanares el Real", "Colmenar Viejo"]
  },
  { 
    name: "Soto del Real", 
    timeToArrive: "15 minutos", 
    ...
    nearbyLocations: ["Manzanares el Real", "Miraflores de la Sierra", "Colmenar Viejo", "El Boalo"]
  }
];
